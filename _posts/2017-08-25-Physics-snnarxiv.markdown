...
As we move toward the final and complete domination of the human race by artificial intelligences, one small project to pass away my remaining time as a free biological being is to build an alternative version of snarXiv using simple Neural Network technology. From now, I will refer to this attempt as sNNarXiv. 

The basic problem is to learn

As I am not an expert of Machine Learning, but mainly a self-taught amateur, I will end up using mostly off-the-shelf code written by others with minor, but important, modification. 
